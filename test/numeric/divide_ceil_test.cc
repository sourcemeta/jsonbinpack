...
TEST(Numeric, divide_ceil_simple_positive) {
...
TEST(Numeric, divide_ceil_simple_negative) {
  const std::int64_t dividend{-10};
  const std::uint64_t divisor{5};
  const std::int64_t result{-2};
  EXPECT_EQ(sourcemeta::jsonbinpack::divide_ceil(dividend, divisor), result);
...
TEST(Numeric, divide_ceil_small_positive) {
...
TEST(Numeric, divide_ceil_small_negative) {
  const std::int64_t dividend{-11};
  const std::uint64_t divisor{5};
  const std::int64_t result{-2};
  EXPECT_EQ(sourcemeta::jsonbinpack::divide_ceil(dividend, divisor), result);
...
TEST(Numeric, divide_ceil_positive_large_divisor) {
  const std::int64_t dividend{11};
...
TEST(Numeric, divide_ceil_negative_large_divisor) {
  const std::int64_t dividend{-11};
  const std::uint64_t divisor{20};
...
TEST(Numeric, divide_ceil_max_dividend_min_divisor) {
...
TEST(Numeric, divide_ceil_min_dividend_min_divisor) {
...
TEST(Numeric, divide_ceil_max_dividend_max_divisor) {
...
TEST(Numeric, divide_ceil_min_dividend_max_divisor) {
