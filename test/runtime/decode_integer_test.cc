...
TEST(BOUNDED_MULTIPLE_8BITS_ENUM_FIXED__minus_5_minus_5_minus_1_1) {
  ...
  const auto result = decoder.BOUNDED_MULTIPLE_8BITS_ENUM_FIXED(
...
TEST(BOUNDED_MULTIPLE_8BITS_ENUM_FIXED__2_minus_5_5_1) {
  sourcemeta::core::InputByteStream stream{0x07};
  sourcemeta::jsonbinpack::Decoder decoder{stream};
  const auto result = decoder.BOUNDED_MULTIPLE_8BITS_ENUM_FIXED(
      {.minimum = -5, .maximum = 5, .multiplier = 1});
  const sourcemeta::core::JSON expected{2};
  EXPECT_EQ(result, expected);
}

TEST(BOUNDED_MULTIPLE_8BITS_ENUM_FIXED__5_2_8_1) {
  sourcemeta::core::InputByteStream stream{0x03};
  sourcemeta::jsonbinpack::Decoder decoder{stream};
  const auto result = decoder.BOUNDED_MULTIPLE_8BITS_ENUM_FIXED(
      {.minimum = 2, .maximum = 8, .multiplier = 1});
  const sourcemeta::core::JSON expected{5};
  EXPECT_EQ(result, expected);
}
...
TEST(BOUNDED_MULTIPLE_8BITS_ENUM_FIXED__5_1_19_5) {
  ...
  sourcemeta::jsonbinpack::Decoder decoder{stream};
  const auto result = decoder.BOUNDED_MULTIPLE_8BITS_ENUM_FIXED(
      {.minimum = 1, .maximum = 19, .multiplier = 5});
  const sourcemeta::core::JSON expected{5};
  EXPECT_EQ(result, expected);
}

TEST(BOUNDED_MULTIPLE_8BITS_ENUM_FIXED__255_0_255_1) {
  sourcemeta::core::InputByteStream stream{0xff};
  sourcemeta::jsonbinpack::Decoder decoder{stream};
  const auto result = decoder.BOUNDED_MULTIPLE_8BITS_ENUM_FIXED(
...
TEST(FLOOR_MULTIPLE_ENUM_VARINT__minus_3_minus_10_1) {
  ...
  sourcemeta::jsonbinpack::Decoder decoder{stream};
  const auto result =
      decoder.FLOOR_MULTIPLE_ENUM_VARINT({.minimum = -10, .multiplier = 1});
...
TEST(FLOOR_MULTIPLE_ENUM_VARINT__5_2_1) {
  ...
  sourcemeta::jsonbinpack::Decoder decoder{stream};
  const auto result =
      decoder.FLOOR_MULTIPLE_ENUM_VARINT({.minimum = 2, .multiplier = 1});
  const sourcemeta::core::JSON expected{5};
  EXPECT_EQ(result, expected);
}
...
TEST(FLOOR_MULTIPLE_ENUM_VARINT__10_5_5) {
  ...
  sourcemeta::jsonbinpack::Decoder decoder{stream};
  const auto result =
      decoder.FLOOR_MULTIPLE_ENUM_VARINT({.minimum = 5, .multiplier = 5});
...
TEST(FLOOR_MULTIPLE_ENUM_VARINT__10_2_5) {
  ...
  sourcemeta::jsonbinpack::Decoder decoder{stream};
  const auto result =
      decoder.FLOOR_MULTIPLE_ENUM_VARINT({.minimum = 2, .multiplier = 5});
  const sourcemeta::core::JSON expected{10};
  EXPECT_EQ(result, expected);
}

TEST(FLOOR_MULTIPLE_ENUM_VARINT__1000_minus_2_4) {
  sourcemeta::core::InputByteStream stream{0xfa, 0x01};
  sourcemeta::jsonbinpack::Decoder decoder{stream};
  const auto result =
      decoder.FLOOR_MULTIPLE_ENUM_VARINT({.minimum = -2, .multiplier = 4});
...
TEST(ROOF_MULTIPLE_MIRROR_ENUM_VARINT__minus_3_minus_2_1) {
  sourcemeta::core::InputByteStream stream{0x01};
  sourcemeta::jsonbinpack::Decoder decoder{stream};
  const auto result = decoder.ROOF_MULTIPLE_MIRROR_ENUM_VARINT(
...
TEST(ROOF_MULTIPLE_MIRROR_ENUM_VARINT__8_10_1) {
  sourcemeta::core::InputByteStream stream{0x02};
  sourcemeta::jsonbinpack::Decoder decoder{stream};
  const auto result = decoder.ROOF_MULTIPLE_MIRROR_ENUM_VARINT(
...
TEST(ARBITRARY_MULTIPLE_ZIGZAG_VARINT__10_5) {
  sourcemeta::core::InputByteStream stream{0x04};
  sourcemeta::jsonbinpack::Decoder decoder{stream};
...
TEST(ARBITRARY_MULTIPLE_ZIGZAG_VARINT__int64_max_1) {
  sourcemeta::core::InputByteStream stream{0xfe, 0xff, 0xff, 0xff, 0xff,
...
TEST(ARBITRARY_MULTIPLE_ZIGZAG_VARINT__int64_min_1) {
  sourcemeta::core::InputByteStream stream{0xfd, 0xff, 0xff, 0xff, 0xff,
                                           0xff, 0xff, 0xff, 0xff, 0x01};
  sourcemeta::jsonbinpack::Decoder decoder{stream};
  const auto result = decoder.ARBITRARY_MULTIPLE_ZIGZAG_VARINT({1});
