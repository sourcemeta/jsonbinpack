...
TEST(JSONBinPack_Encoder, ANY_PACKED_TYPE_TAG_BYTE_PREFIX__string_31_xs) {
  ...
  EXPECT_EQ(
      stream.bytes(),
      (std::vector<std::byte>{
          std::byte{0x02}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
...
TEST(JSONBinPack_Encoder, ANY_PACKED_TYPE_TAG_BYTE_PREFIX__string_61_xs) {
  ...
  EXPECT_EQ(
      stream.bytes(),
      (std::vector<std::byte>{
          std::byte{0xf2}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
...
TEST(JSONBinPack_Encoder, ANY_PACKED_TYPE_TAG_BYTE_PREFIX__string_128_xs) {
  ...
  EXPECT_EQ(
      stream.bytes(),
      (std::vector<std::byte>{
          std::byte{0x3f}, std::byte{0x00}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
...
TEST(JSONBinPack_Encoder, ANY_PACKED_TYPE_TAG_BYTE_PREFIX__string_130_xs) {
  ...
  EXPECT_EQ(
      stream.bytes(),
      (std::vector<std::byte>{
          std::byte{0x3f}, std::byte{0x02}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
...
TEST(JSONBinPack_Encoder, ANY_PACKED_TYPE_TAG_BYTE_PREFIX__string_256_xs) {
  ...
  EXPECT_EQ(
      stream.bytes(),
      (std::vector<std::byte>{
          std::byte{0x47}, std::byte{0x00}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
...
TEST(JSONBinPack_Encoder, ANY_PACKED_TYPE_TAG_BYTE_PREFIX__string_258_xs) {
  ...
  EXPECT_EQ(
      stream.bytes(),
      (std::vector<std::byte>{
          std::byte{0x47}, std::byte{0x02}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
...
TEST(JSONBinPack_Encoder, ANY_PACKED_TYPE_TAG_BYTE_PREFIX__string_512_xs) {
  ...
  EXPECT_EQ(
      stream.bytes(),
      (std::vector<std::byte>{
          std::byte{0x4f}, std::byte{0x00}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
...
TEST(JSONBinPack_Encoder, ANY_PACKED_TYPE_TAG_BYTE_PREFIX__string_513_xs) {
  ...
  EXPECT_EQ(
      stream.bytes(),
      (std::vector<std::byte>{
          std::byte{0x4f}, std::byte{0x01}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
...
TEST(JSONBinPack_Encoder, ANY_PACKED_TYPE_TAG_BYTE_PREFIX__string_1024_xs) {
  ...
  EXPECT_EQ(
      stream.bytes(),
      (std::vector<std::byte>{
          std::byte{0x57}, std::byte{0x00}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
...
TEST(JSONBinPack_Encoder,
  ...
  EXPECT_EQ(
      stream.bytes(),
      (std::vector<std::byte>{
          std::byte{0x01}, std::byte{0x01}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
...
TEST(JSONBinPack_Encoder,
  ...
  EXPECT_EQ(
      stream.bytes(),
      (std::vector<std::byte>{
          std::byte{0x01}, std::byte{0x02}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
          std::byte{0x78}, std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
...
TEST(JSONBinPack_Encoder, ANY_PACKED_TYPE_TAG_BYTE_PREFIX__array_31) {
  ...
  EXPECT_EQ(
      stream.bytes(),
      (std::vector<std::byte>{
          std::byte{0x04}, std::byte{0x00}, std::byte{0x0f}, std::byte{0x0f},
          std::byte{0x0f}, std::byte{0x0f}, std::byte{0x0f}, std::byte{0x0f},
          std::byte{0x0f}, std::byte{0x0f}, std::byte{0x0f}, std::byte{0x0f},
          std::byte{0x0f}, std::byte{0x0f}, std::byte{0x0f}, std::byte{0x0f},
          std::byte{0x0f}, std::byte{0x0f}, std::byte{0x0f}, std::byte{0x0f},
...
TEST(JSONBinPack_Encoder, ANY_PACKED_TYPE_TAG_BYTE_PREFIX__array_32) {
  ...
  EXPECT_EQ(
      stream.bytes(),
      (std::vector<std::byte>{
          std::byte{0x04}, std::byte{0x01}, std::byte{0x0f}, std::byte{0x0f},
          std::byte{0x0f}, std::byte{0x0f}, std::byte{0x0f}, std::byte{0x0f},
          std::byte{0x0f}, std::byte{0x0f}, std::byte{0x0f}, std::byte{0x0f},
          std::byte{0x0f}, std::byte{0x0f}, std::byte{0x0f}, std::byte{0x0f},
          std::byte{0x0f}, std::byte{0x0f}, std::byte{0x0f}, std::byte{0x0f},
...
TEST(JSONBinPack_Encoder,
  ...
  if (document.as_object().cbegin()->first == "foo") {
    EXPECT_EQ(stream.bytes(),
              (std::vector<std::byte>{
                  std::byte{0x1b}, std::byte{0x04}, std::byte{0x66},
                  std::byte{0x6f}, std::byte{0x6f}, std::byte{0x01},
                  std::byte{0x01}, std::byte{0x78}, std::byte{0x78},
                  std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
                  std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
                  std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
                  std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
                  ...
                  std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
                  std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
                  std::byte{0x04}, std::byte{0x62}, std::byte{0x61},
                  std::byte{0x72}, std::byte{0x00}, std::byte{0x01},
                  std::byte{0x44}}));
  } else {
    EXPECT_EQ(stream.bytes(),
              (std::vector<std::byte>{
                  std::byte{0x1b}, std::byte{0x04}, std::byte{0x62},
                  std::byte{0x61}, std::byte{0x72}, std::byte{0x01},
                  std::byte{0x01}, std::byte{0x78}, std::byte{0x78},
                  std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
                  std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
                  std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
                  ...
                  std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
                  std::byte{0x78}, std::byte{0x78}, std::byte{0x78},
                  std::byte{0x04}, std::byte{0x66}, std::byte{0x6f},
