...
TEST(JSONBinPack_numeric, divide_floor_simple_negative) {
  const std::int64_t dividend{-10};
  const std::uint64_t divisor{5};
  const std::int64_t result{-2};
  EXPECT_EQ(sourcemeta::jsonbinpack::divide_floor(dividend, divisor), result);
...
TEST(JSONBinPack_numeric, divide_floor_small_positive) {
...
TEST(JSONBinPack_numeric, divide_floor_small_negative) {
  const std::int64_t dividend{-11};
  const std::uint64_t divisor{5};
...
TEST(JSONBinPack_numeric, divide_floor_positive_large_divisor) {
  const std::int64_t dividend{11};
...
TEST(JSONBinPack_numeric, divide_floor_negative_large_divisor) {
  const std::int64_t dividend{-11};
  const std::uint64_t divisor{20};
...
TEST(JSONBinPack_numeric, divide_floor_max_dividend_min_divisor) {
...
TEST(JSONBinPack_numeric, divide_floor_min_dividend_min_divisor) {
...
TEST(JSONBinPack_numeric, divide_floor_max_dividend_max_divisor) {
...
TEST(JSONBinPack_numeric, divide_floor_min_dividend_max_divisor) {
