...
TEST(Encoder, BOUNDED_TYPED_ARRAY_true_false_true__no_prefix_encodings) {
  using namespace sourcemeta::jsonbinpack;
  sourcemeta::jsontoolkit::JSON document{
      sourcemeta::jsontoolkit::parse("[ true, false, true ]")};
  OutputByteStream<char> stream{};
...
TEST(Encoder, BOUNDED_TYPED_ARRAY_true_false_true__same_max_min) {
  using namespace sourcemeta::jsonbinpack;
  sourcemeta::jsontoolkit::JSON document{
      sourcemeta::jsontoolkit::parse("[ true, false, true ]")};
  OutputByteStream<char> stream{};
...
TEST(Encoder, BOUNDED_TYPED_ARRAY_true_false_5__1_3) {
  using namespace sourcemeta::jsonbinpack;
  sourcemeta::jsontoolkit::JSON document{
      sourcemeta::jsontoolkit::parse("[ true, false, 5 ]")};
  OutputByteStream<char> stream{};
...
TEST(Encoder, BOUNDED_TYPED_ARRAY_complex) {
  using namespace sourcemeta::jsonbinpack;
  sourcemeta::jsontoolkit::JSON document{
      sourcemeta::jsontoolkit::parse("[ true, \"foo\", 1000 ]")};
  OutputByteStream<char> stream{};
