#ifndef SOURCEMETA_BLAZE_FOUNDATION_ERROR_H
#define SOURCEMETA_BLAZE_FOUNDATION_ERROR_H
...
class SOURCEMETA_BLAZE_FOUNDATION_EXPORT SchemaError : public std::exception {
public:
...
class SOURCEMETA_BLAZE_FOUNDATION_EXPORT SchemaResolutionError
...
class SOURCEMETA_BLAZE_FOUNDATION_EXPORT SchemaRelativeMetaschemaResolutionError
...
/// @ingroup foundation
/// An error that represents a schema resolution failure event
class SOURCEMETA_BLAZE_FOUNDATION_EXPORT SchemaReferenceError
    : public std::exception {
public:
...
class SOURCEMETA_BLAZE_FOUNDATION_EXPORT SchemaUnknownDialectError
    : public std::exception {
public:
...
/// determined
class SOURCEMETA_BLAZE_FOUNDATION_EXPORT SchemaUnknownBaseDialectError
    : public std::exception {
public:
...
class SOURCEMETA_BLAZE_FOUNDATION_EXPORT SchemaReferenceObjectResourceError
    : public std::exception {
public:
