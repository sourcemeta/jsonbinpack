...
export const EVALUATE = 54;
export const LOGICAL_NOT = 55;
export const LOGICAL_NOT_EVALUATE = 56;
export const LOGICAL_OR = 57;
export const LOGICAL_AND = 58;
export const LOGICAL_XOR = 59;
export const LOGICAL_CONDITION = 60;
export const LOGICAL_WHEN_TYPE = 61;
export const LOGICAL_WHEN_DEFINES = 62;
export const LOGICAL_WHEN_ARRAY_SIZE_GREATER = 63;
export const LOOP_PROPERTIES_UNEVALUATED = 64;
export const LOOP_PROPERTIES_UNEVALUATED_EXCEPT = 65;
export const LOOP_PROPERTIES_MATCH = 66;
export const LOOP_PROPERTIES_MATCH_CLOSED = 67;
export const LOOP_PROPERTIES = 68;
export const LOOP_PROPERTIES_EVALUATE = 69;
export const LOOP_PROPERTIES_REGEX = 70;
export const LOOP_PROPERTIES_REGEX_CLOSED = 71;
export const LOOP_PROPERTIES_STARTS_WITH = 72;
export const LOOP_PROPERTIES_EXCEPT = 73;
export const LOOP_PROPERTIES_TYPE = 74;
export const LOOP_PROPERTIES_TYPE_EVALUATE = 75;
export const LOOP_PROPERTIES_EXACTLY_TYPE_STRICT = 76;
export const LOOP_PROPERTIES_EXACTLY_TYPE_STRICT_HASH = 77;
export const LOOP_PROPERTIES_TYPE_STRICT = 78;
export const LOOP_PROPERTIES_TYPE_STRICT_EVALUATE = 79;
export const LOOP_PROPERTIES_TYPE_STRICT_ANY = 80;
export const LOOP_PROPERTIES_TYPE_STRICT_ANY_EVALUATE = 81;
export const LOOP_KEYS = 82;
export const LOOP_ITEMS = 83;
export const LOOP_ITEMS_FROM = 84;
export const LOOP_ITEMS_UNEVALUATED = 85;
export const LOOP_ITEMS_TYPE = 86;
export const LOOP_ITEMS_TYPE_STRICT = 87;
export const LOOP_ITEMS_TYPE_STRICT_ANY = 88;
export const LOOP_ITEMS_PROPERTIES_EXACTLY_TYPE_STRICT_HASH = 89;
export const LOOP_ITEMS_PROPERTIES_EXACTLY_TYPE_STRICT_HASH3 = 90;
export const LOOP_ITEMS_INTEGER_BOUNDED = 91;
export const LOOP_ITEMS_INTEGER_BOUNDED_SIZED = 92;
...
export const INSTRUCTION_NAMES = {
  ...
  "AnnotationEmitWrapped": ANNOTATION_EMIT_WRAPPED,
...
export function isWrappedAnnotationOpcode(opcode) {
  return opcode === ANNOTATION_EMIT_WRAPPED || opcode === ANNOTATION_BASENAME_TO_PARENT;
}
