...
auto sourcemeta::core::official_resolver(std::string_view identifier)
  ...
  if (identifier == "https://json-schema.org/draft/2020-12/schema") {
    return sourcemeta::core::parse(R"EOF(@METASCHEMA_JSONSCHEMA_2020_12@)EOF");
  } else if (identifier ==
             "https://json-schema.org/draft/2020-12/hyper-schema") {
    return sourcemeta::core::parse(R"EOF(@METASCHEMA_HYPERSCHEMA_2020_12@)EOF");
  } else if (identifier ==
    ...
    return sourcemeta::core::parse(R"EOF(@METASCHEMA_LINKS_2020_12@)EOF");
  } else if (identifier ==
    ...
    return sourcemeta::core::parse(R"EOF(@METASCHEMA_JSONSCHEMA_2019_09@)EOF");
  } else if (identifier ==
             "https://json-schema.org/draft/2019-09/hyper-schema") {
    return sourcemeta::core::parse(R"EOF(@METASCHEMA_HYPERSCHEMA_2019_09@)EOF");
  } else if (identifier ==
    ...
    return sourcemeta::core::parse(R"EOF(@METASCHEMA_LINKS_2019_09@)EOF");
  } else if (identifier ==
