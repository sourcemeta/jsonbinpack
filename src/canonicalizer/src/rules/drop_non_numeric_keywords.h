...
static const std::set<std::string> BLACKLIST_APPLICATOR{
...
static const std::set<std::string> BLACKLIST_UNEVALUATED{
    keywords::unevaluated::unevaluatedItems,
    keywords::unevaluated::unevaluatedProperties};

static const std::set<std::string> BLACKLIST_VALIDATION{
...
static const std::set<std::string> BLACKLIST_FORMAT_ANNOTATION{
    keywords::format_annotation::format};

static const std::set<std::string> BLACKLIST_FORMAT_ASSERTION{
    keywords::format_assertion::format};

static const std::set<std::string> BLACKLIST_CONTENT{
