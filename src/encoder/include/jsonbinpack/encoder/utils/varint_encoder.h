#ifndef SOURCEMETA_JSONBINPACK_ENCODER_UTILS_VARINT_H_
#define SOURCEMETA_JSONBINPACK_ENCODER_UTILS_VARINT_H_
...
auto varint_encode(std::basic_ostream<CharT, Traits> &stream, const T value)
